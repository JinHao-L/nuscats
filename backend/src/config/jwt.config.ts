...
export const jwtConfig = registerAs('jwt', () => ({
  token_secret: env.JWT_ACCESS_TOKEN_SECRET, // in seconds
  token_expiry: env.JWT_ACCESS_TOKEN_EXPIRATION_TIME,
  refresh_secret: env.JWT_REFRESH_TOKEN_SECRET, // in seconds
  refresh_expiry: env.JWT_REFRESH_TOKEN_EXPIRATION_TIME,
  mail_verify_secret: env.JWT_MAIL_VERIFY_SECRET, // in seconds
